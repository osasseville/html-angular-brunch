describe "HtmlAngularJsCompiler", ->
  describe "Public surface", ->
    it "Should exists", ->
      Plugin.should.exist
      Plugin.name.should.equal "HtmlAngularJsCompiler"
    ...
    describe "Parts of main function", ->
      describe "prepareResult", ->
        ...
        it "Must return pairs with path and result on correct compileTrigger", ->
          result = plugin.prepareResult([
            sourceFiles: [
              path: "test/folder/partial1.html"
            ,
              path: "test/folder/partial2.html"
            ]
            path: compileTrigger
          ])
          ...
          for v, i in ['partial1.html', 'partial2.html']
            r = result[i]
      ...
      describe "attachModuleNameToTemplate", ->
        ...
        it "Pair should be placed in child module in a case when a folder with index.html has child folder with own index.html", ->
          pair =
            path: ['app', 'folder', 'file.html']
            content: "<!DOCTYPE html>"
        ...
        it "Pair in deeper path of the last folder with index.html should be placed in last parent", ->
          pair =
            path: ['app', 'folder', 'folder', 'file.html']
            content: "<!DOCTYPE html>"
    ...
    describe "Post-compile hook", ->
      data = [
        ...
        ,
          path: "test/folder/partial2.html"
        ,
          path: "test/folder/folder/index.html"
        ,
          path: "test/folder/folder/partial1.html"
        ,
          path: "test/folder/folder/partial2.html"
        ]
        path: compileTrigger
      ]
